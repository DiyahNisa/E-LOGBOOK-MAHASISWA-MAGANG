            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $lpr->univ }}</td>
                        <td>
                            <a href="{{url('/laporanDetail/'.$lpr->id)}}" class="on-default edit-row btn btn-warning"><i class="fa fa-eye"></i></a>
                            <a href="{{url('/cetak/'.$lpr->id)}}" class="btn btn-primary" target="_blank"><i class="fa fa-print"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
